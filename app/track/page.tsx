...
const GAS_URL = process.env.NEXT_PUBLIC_GAS_URL || "https://script.google.com/macros/s/AKfycbwt7WkKDh_OFaZ63BSZxekgqpULTP7OAU1SrkGIRdTGMAhHJKrm5GQrpmPQqihyjnQrTw/exec";
